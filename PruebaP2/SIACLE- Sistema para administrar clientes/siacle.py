...
por The Informatic Hamster Y TROLIN MIGUELON  con fines educativos. Sientase libre de usarla.
"""
...
class Acerca(QDialog):
    ...
    def initUI(self):
        ...
        labelAcerca = QLabel("SIACLE: sistema para administrar clientes, diseñado y\ndesarrollado "
                             " el trolin del MIGUELON con fines educativos.", self)
...
class Siacle(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QIcon("Imagenes/Qt.png"))
        self.setWindowTitle("SIACLE (Sistema para administrar clientes por:  el trolin del MIGUELON)")
